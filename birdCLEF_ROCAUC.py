"""
The following code is a copy-paste from https://www.kaggle.com/code/metric/birdclef-roc-auc as of 28/03/2026
It was the easiest way to integrate the measure into the model evaluation pipeline
