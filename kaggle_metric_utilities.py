"""
The following code is a copy-paste as of 28/03/2026
It was the easiest way to integrate the measure into the model evaluation pipeline (the import was not successful)
I do not own any rights on it, contact me if anything is off to peacefully solve the question
"""

# %% [code]
'''
Forked from v5 of the official version.
